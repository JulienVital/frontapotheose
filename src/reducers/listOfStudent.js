...
export const initialState = {
  ...
  filterSortDisponibilityOption: [{ id: 'allDisponibility', value: 'allDisponibility', name: 'Tous' }, { id: 'close', value: 'false', name: 'Indisponible' }, { id: 'open', value: 'true', name: 'Disponible pour une offre' }],
  filteredata: [],
};
